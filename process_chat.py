...
class whatsAppChat: 
    ...
    def chat_to_df(self): 
        ...
        # remove date/time 
        messages_woDateTime , messages_dt = self.extractDateTime(messages)
        # remove username
        messages_woUser, messages_user = self.extractUsers(messages_woDateTime)
            
        return messages_woUser, messages_dt, messages_user
